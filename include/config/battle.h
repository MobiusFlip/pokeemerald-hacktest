...
#define B_STEEL_RESISTANCES         GEN_4 // In Gen6+, Steel-type Pokémon are no longer resistant to Dark-type and Ghost-type moves.
...
#define B_DEFOG_CLEARS_TERRAIN      GEN_4 // In Gen8+, Defog also clears active Terrain.
...
#define B_OVERWORLD_SNOW                GEN_4 // In Gen9+, overworld Snow will summon snow instead of hail.
